...
// Source: ./sanity/lib/orders/getOrdersByUserId.ts
// Variable: GET_ORDERS_BY_USER_ID_QUERY
// Query: *[_type == "order" && clerkUserId == $userId] | order(name desc) {                ...,                products[]{                    ...,                    product->                }            }
export type GET_ORDERS_BY_USER_ID_QUERYResult = Array<{
  _id: string;
  _type: "order";
  _createdAt: string;
  _updatedAt: string;
...
// Query: * [_type == "product" && (name match $searchParam || slug.current match $searchParam)] | order(name asc)
